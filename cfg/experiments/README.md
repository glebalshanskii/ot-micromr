...
| `EMP-MARK-CT-001` | `emp_mark_ct_001.toml` | Continuous-hazard refit/filter with endpoint event intensity and nested path quadrature | preregistered; pending target run |
