...
| `FILTER-SYN-001` | `filter_syn_001.toml` | Causal six-event particle-filter identification against naive/Kalman controls | preregistered; implementation pending |
| `EMP-FILTER-001` | `emp_filter_001.toml` | Train-only OKX parameter fit and causal filter diagnostics | protocol preregistered; target config awaits synthetic dependency |
